...
import (
	...
	"github.com/stardusteight-d4c/fclx-chatgpt-microservice/chat-service/internal/infra/db"
)
...
func NewChatRepositoryMySQL(dbConnection *sql.DB) *ChatRepositoryMySQL {
